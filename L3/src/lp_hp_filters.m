function H_out = lp_hp_filters(filter_type, lp_or_hp, P, Q, D0, n)
    % The function calculates the LP or HP filters based on the parameters given.
    % Filter_type=('ideal' or 'btw' or 'gaussian'), %lp_or_hp=('lp' or 'hp' for low pass or high pass),
    % P, Q are the padded image size, D0 is the cutoff frequency,
    % and n for the order of the filter for btw filters
