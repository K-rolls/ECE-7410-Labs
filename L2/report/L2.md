...
3. *Calculate and report the optimal threshold values for `im3.png` and `im4.png` found using your code in **Thresholding: Step 2**.*
...
5. *Use the optimal thresholds to generate and display binary image for `img3.png` and `img4.png`.*
    ...
    ![binary image of `img3.png` with $threshold = XXX$](./outputs/03_thresholding/bin3.png){#11 width=50%}

    ![binary image of `img4.png` with $threshold = XXX$](./outputs/03_thresholding/bin4.png){#12 width=50%}
